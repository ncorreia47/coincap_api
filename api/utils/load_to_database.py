...
class Database:
    ...
    def create_connection(self, env_name:str):
        """
    ...
    def load_dataframe(self, dataframe: pd.DataFrame, context: str, env_name: str, schema: str):
        """
        ...
        connection = self.create_connection(env_name)
